...
export default function DataTableTemplateEvidencia() {
...
const fetchLogTask = async () => {
  try {
    console.log('API fetchTasks enviado a rota ', API_URL, '/log_template_evidences - GET');
    const response = await axios.get(`${API_URL}/log_template_evidences`);
