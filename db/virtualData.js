...
con.connect(function(err) {
	...
	(1, 'Em andamento', 'Processo 2', NOW(), '2023-11-15', 'Implementação de novas políticas de segurança da informação.'),
	(0, 'Concluída', 'Processo 3', NOW(), '2023-10-20', 'Treinamento de novos funcionários para a equipe de suporte técnico.'),
	(1, 'Atrasada', 'Processo 4', NOW(), '2023-09-30', 'Desenvolvimento de um aplicativo móvel para clientes.'),
	(1, 'Em andamento', 'Processo 5', NOW(), '2023-11-10', 'Planejamento e organização de um evento corporativo.'),
	(0, 'Concluída', 'Processo 6', NOW(), '2023-08-25', 'Revisão e atualização da política de privacidade da empresa.'),
	(1, 'Atrasada', 'Processo 7', NOW(), '2023-09-15', 'Implementação de um sistema de gerenciamento de projetos.'),
	(1, 'Em andamento', 'Processo 8', NOW(), '2023-11-05', 'Desenvolvimento de um novo produto para o mercado.'),
	(0, 'Concluída', 'Processo 9', NOW(), '2023-10-05', 'Análise de mercado para identificação de oportunidades de negócios.'),
	...
	(1, 1, 'Em andamento', 'Task 1: Revisar requisitos', NOW(), '2023-11-10', 'Revisão dos requisitos para o sistema de documentação de vendas'),
	...
	(1, 1, 'Concluída', 'Task 4: Testes de qualidade', NOW(), '2023-11-25', 'Realizar testes de qualidade no sistema de documentação de vendas'),
	(1, 1, 'Atrasada', 'Task 5: Implementar melhorias', NOW(), '2023-11-30', 'Implementar melhorias no sistema de documentação de vendas'),
	(2, 1, 'Em andamento', 'Task 1: Avaliação de Riscos', NOW(), '2023-11-12', 'Realizar uma avaliação detalhada dos riscos de segurança da informação'),
	...
	(2, 1, 'Concluída', 'Task 4: Implementação de Ferramentas', NOW(), '2023-11-26', 'Implementar ferramentas de segurança da informação para proteger dados sensíveis'),
	...
	(3, 1, 'Em andamento', 'Task 1: Preparação de Materiais', NOW(), '2023-11-14', 'Preparar materiais de treinamento para os novos funcionários'),
	...
	(3, 1, 'Concluída', 'Task 4: Treinamento Técnico', NOW(), '2023-11-28', 'Conduzir treinamento técnico para as habilidades necessárias no suporte técnico'),
	...
	(4, 1, 'Em andamento', 'Task 1: Requisitos do Cliente', NOW(), '2023-11-16', 'Realizar reuniões com os clientes para entender os requisitos do aplicativo móvel'),
	...
	(4, 1, 'Concluída', 'Task 4: Desenvolvimento Back-end', NOW(), '2023-11-29', 'Construir a lógica e a funcionalidade do servidor para suportar o aplicativo móvel'),
	...
	(5, 1, 'Em andamento', 'Task 1: Definir Objetivos e Tema', NOW(), '2023-11-10', 'Definir os objetivos e o tema do evento corporativo'),
	...
	(5, 1, 'Concluída', 'Task 4: Logística e Preparação', NOW(), '2023-11-25', 'Organizar a logística e preparar os materiais e recursos necessários'),
	(5, 1, 'Atrasada', 'Task 5: Promoção e Registro', NOW(), '2023-11-30', 'Promover o evento e gerenciar o registro dos participantes'),
	(6, 1, 'Em andamento', 'Task 1: Avaliação da Política Atual', NOW(), '2023-11-15', 'Avaliar a política de privacidade atual da empresa'),
	...
	(6, 1, 'Concluída', 'Task 4: Revisão Legal', NOW(), '2023-11-28', 'Obter revisão legal da nova política de privacidade'),
	...
	(7, 1, 'Em andamento', 'Task 1: Avaliação de Requisitos', NOW(), '2023-11-15', 'Avaliar os requisitos e necessidades da equipe para o sistema de gerenciamento de projetos'),
	...
	(7, 1, 'Concluída', 'Task 4: Treinamento da Equipe', NOW(), '2023-11-28', 'Treinar a equipe para utilizar efetivamente o novo sistema de gerenciamento de projetos'),
	...
	(8, 1, 'Em andamento', 'Task 1: Pesquisa de Mercado', NOW(), '2023-11-05', 'Realizar pesquisa de mercado para identificar demanda e preferências dos clientes'),
	...
	(8, 1, 'Concluída', 'Task 4: Testes de Qualidade', NOW(), '2023-11-20', 'Realizar testes de qualidade para garantir que o produto atenda aos padrões estabelecidos'),
	...
	(9, 1, 'Em andamento', 'Task 1: Definição de Objetivos', NOW(), '2023-10-05', 'Definir os objetivos da análise de mercado e as métricas de sucesso'),
	...
	(9, 1, 'Concluída', 'Task 4: Identificação de Oportunidades', NOW(), '2023-10-20', 'Analisar dados para identificar oportunidades de negócios no mercado'),
	...
	(10, 1, 'Em andamento', 'Task 1: Avaliação do Desempenho Atual', NOW(), '2023-11-05', 'Avaliar o desempenho atual da empresa, identificar áreas de melhoria e pontos fortes'),
	...
	(10, 1, 'Concluída', 'Task 4: Estratégias e Iniciativas', NOW(), '2023-11-20', 'Desenvolver estratégias e iniciativas para alcançar as metas e objetivos estabelecidos'),
